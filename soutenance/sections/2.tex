...
\begin{frame}{Contraintes et enjeux}
  ...
  \begin{alertblock}{Problématique}
    Comment planifier les interventions de manière à utiliser efficacement les blocs opératoires tout en maintenant une occupation équilibrée des lits et en restant robuste aux urgences ?
  \end{alertblock}
